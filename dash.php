...
$query="insert into dash(username,email,phone,education,address,objective,language,skill,experience,hobbies,linkedin,instagram) values ('$username','$email','$phone','$education','$address','$objective','$language','$skill','$experience','$hobbies','$linkedin','$instagram')";
...
<div class="container">
    ...
    <form class="dash" method="post" onsubmit="return checkForNull();">
