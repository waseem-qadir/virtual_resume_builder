...
$query = "SELECT * FROM dash2 ORDER BY id DESC LIMIT 1";
...
if (mysqli_num_rows($result) == 1) {
    ...
    <head>
        ...
        <title>resume</title>
        <link rel='stylesheet' href='retrive2.css'>
    <style>
    .img {
        height: 250px;
        border-radius: 100%;
    ...
    .row::before {
        ...
        left: 0;
        width: 100%;
        height: 265px; /* Height of the colored section */
        background-color: lightseagreen; /* Color of the top section */
    ...
    h2::after {
        ...
        background-color: lightseagreen; /* Color of the underline */
    }
        ...
        <div class='resume'>
            ...
            <img src='" . $row['profile_pic'] . "' class='img' alt='profile_pic'>
                ...
                <div class='section-title'><h2>contact</h2>
                    ...
                    <p class='blue'>+91  "  . $row['phone'] ."</p>
                    <p class='blue'> " . $row['email'] . "</p>
                    <p  class='blue'>" .$row['linkedin']."</p>
                    <p  class='blue'>" .$row['instagram']."</p> 
                ...
                <div class='section-title'><h2>interest</h2>
            ...
            <div class='row2'>
                ...
                <h3 class='eleedu'>elementary educator</h3>
                
                    
                <div class='section-title'><h2>profile summary</h2>
                     <p class='address'>" .$row['address']."    
                    </p>
                </div>
                      
                <div class=section-title><h2>Teaching Experience</h2>
                        ...
                        <div class='section-title'><h2>certificate</h2>
...
<script>
    function applyTheme() {
        ...
        if (color === "red") {
            window.location.href = "retrive2_1.php";
        } else if (color === "blue") {
            window.location.href = "retrive2_2.php";
        } else if (color === "green") {
            window.location.href = "retrive2_3.php";
        } else if (color === "golden") {
            window.location.href = "retrive2_4.php";
        }
    }
